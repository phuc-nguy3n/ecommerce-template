  ...
  return (
    <div className="grid grid-cols-2 xl:gap-6 lg:gap-x-6 md:gap-x-6 gap-y-10">
      ...
      <div className="flex items-center col-span-2 xl:order-1 lg:order-3 md:order-3">
        <div className="lg:flex-grow-0 flex-grow overflow-hidden relative box">
          <img
            className="xl:h-[360px] md:h-[500px] h-[300px] xl:w-[555px] lg:w-[560px] w-full object-cover transform transition-transform duration-500 hover:scale-105"
          ...
          {/* Overlay */}
          <div className="absolute top-0 xl:w-[555px] lg:w-[560px] w-full xl:h-[360px] md:h-[500px] h-[300px] gradient-bg home flex flex-col md:p-[30px] p-[10px]">
        ...
        <div className="lg:flex hidden xl:px-[30px] xl:py-[20px] lg:p-[20px] xl:h-[360px] lg:h-[500px] flex-1 flex-col justify-between bg-gray-100 dark:bg-[#393939]">
          <div>
            <h2 className="font-bold text-[30px] leading-[1.417] mb-[15px] cursor-pointer hover:text-[#ff1d50] transition-colors duration-300 ease-in-out line-clamp-4">
              Following the Moon, they are in Close space. Choose the best
            </h2>

            <p className="text-[#7e848d] leading-[1.75] font-medium line-clamp-3">
      ...
      {/* Second news */}
      <div className="md:col-span-1 col-span-2 overflow-hidden lg:order-1 xl:order-2 relative box">
        <img
          className="xl:h-[288px] lg:h-[436px] md:h-[316px] h-[300px] xl:w-[429px] lg:w-[436px] md:w-[316px] w-full object-cover transform transition-transform duration-500 hover:scale-105"
        ...
        {/* Overlay */}
        <div className="absolute top-0 xl:w-[429px] lg:w-[436px] md:w-[316px] w-full xl:h-[288px] lg:h-[436px] md:h-[316px] h-[300px] gradient-bg home flex flex-col md:p-[20px] p-[10px]">
