    ...
    <div className="grid grid-cols-2 xl:gap-6 lg:gap-x-6 md:gap-x-6 gap-y-10">
      ...
      <div className="flex items-center col-span-2 xl:order-1 lg:order-3 md:order-3">
        <div className="lg:flex-grow-0 flex-grow overflow-hidden relative box">
          <img
            className="xl:h-[360px] h-[500px] xl:w-[555px] lg:w-[560px] w-full object-cover transform transition-transform duration-500 hover:scale-105"
          ...
          {/* Overlay */}
          <div className="absolute top-0 xl:w-[555px] lg:w-[560px] w-full xl:h-[360px] lg:h-[500px] h-[500px] gradient-bg home flex flex-col p-[30px]">
      ...
      <div className="md:col-span-1 col-span-2 overflow-hidden lg:order-1 xl:order-2 relative box">
        <img
          className="xl:h-[288px] lg:h-[436px] md:h-[316px] h-[500px] xl:w-[429px] lg:w-[436px] md:w-[316px] w-full object-cover transform transition-transform duration-500 hover:scale-105"
        ...
        {/* Overlay */}
        <div className="absolute top-0 xl:w-[429px] lg:w-[436px] md:w-[316px] w-full xl:h-[288px] lg:h-[436px] md:h-[316px] h-[500px] gradient-bg home flex flex-col p-[20px]">
