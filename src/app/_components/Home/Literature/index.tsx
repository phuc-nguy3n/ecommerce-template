...
export default function LiteratureSection() {
  ...
  const openProductPopup = (isOpen: boolean) => {
    const popup = document.querySelector(".lirerature-popup");
  ...
  return (
    <>
          ...
          <div className="relative">
            <div ref={scrollRef} className={homeStyle.literature.postList}>
              {literaturePosts.map((item, index) => (
                // Item
                <div
                  onClick={() => openProductPopup(true)}
                  className={homeStyle.literature.postItem}
                  key={index}
                >
                  <div className={homeStyle.literature.imgBox}>
                    ...
                    <div className={homeStyle.literature.overlay}>
                      ...
                      <h3 className={homeStyle.literature.title}>
                        {item.title}
                      </h3>
      ...
      <div
        id="popup-fixed"
        className="lirerature-popup flex fixed top-0 bottom-0 left-0 right-0 w-full h-full bg-black bg-opacity-[0.7] items-center z-[1000] overflow-y-scroll"
      >
        <div className="absolute lg:top-[50%] left-[50%] top-0 translate-x-[-50%] lg:translate-y-[-50%] w-full">
          <div className="container xl:max-w-[1248px] lg:max-w-[960px] md:max-w-[720px] sm:max-w-[540px]">
            <div className="grid grid-cols-12 bg-white py-[20px] gap-[20px] my-[20px] relative">
              <div
                onClick={() => openProductPopup(false)}
