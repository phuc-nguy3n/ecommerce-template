  ...
  return (
    <div className="container xl:max-w-[1248px] lg:max-w-[960px] md:max-w-[720px]">
      <div className="flex lg:justify-between justify-center py-[10px]">
        <ul className="lg:flex hidden text-[#54595F] dark:text-[#B5B5B5] text-[13px] privacy-list">
        ...
        <div className="flex items-center text-[13px]">
          <div className="md:flex hidden items-center text-[#54595F] dark:text-[#B5B5B5] gap-2 login-box ">
          ...
          <ul className="flex text-[#54595F] dark:text-[#B5B5B5] xl:gap-4 lg:gap-3 md:gap-3 gap-4 text-[16px] mt-[2px]">
